...
from rcsj_sde.utils2 import hbar_over_2e, kB
...
class JosephsonJunction:
    ...
    def __post_init__(self):
        ...
        self.omega_p = jnp.sqrt(self.Ic/(self.C*hbar_over_2e))
        self.epsilon = jnp.sqrt(2*kB*self.T/(self.Ic*hbar_over_2e))/self.beta
